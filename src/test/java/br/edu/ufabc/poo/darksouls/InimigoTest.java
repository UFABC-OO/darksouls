...
public class InimigoTest{
    ...
    public void testeCavaleiroNegroAtacando() {
    	...
    	assertEquals("Atacando rapido!", cavaleiroNegro.ataqueRapido());
    }
    ...
    public void testeCavaleiroPrataAtacando() {
    	...
    	assertEquals("Cavaleiro de Prata atacando", cavaleiroPrata.atacando());
    	assertEquals("Ataque forte!", cavaleiroPrata.ataqueForte());
    }
}